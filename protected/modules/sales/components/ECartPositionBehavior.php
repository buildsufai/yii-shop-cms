 ...
 */
class ECartPositionBehavior extends CActiveRecordBehavior {
    ...
    public function getSumPriceText()
    {
        return Yii::app()->numberFormatter->formatCurrency($this->getSumPrice(), 'EUR');
    }
