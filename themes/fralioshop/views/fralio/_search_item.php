...
<?php elseif(get_class($data) == 'Content'): ?>
...
<div class="search_item">
    ...
    <?php endif; ?>
    <h2><?php echo CHtml::link( $data->title, $data->getUrl()); ?></h2>
    <p><?php echo $data->getShortDescription(300); ?><br/>
</div>
